...
<%
	...
	NoticeBean notice = edit.getNotice(noticeNum, false);
%>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	<header>
		...
		<fieldset>
			<legend>공지사항</legend>
			<form name="notice_form" method="post" action="edit_ok.jsp?noticeNum=<%= noticeNum %>&pageNum=<%= pageNum %>">
				<div id="info-area">
					...
					<div id="form_flexBox_2">
						<input type="text" name="userID" size="15" maxlength="15" value="<%=notice.getUserID()%>" readonly="readonly">
						&nbsp;<br>
						<input type="text" name="noticeTitle" size="50" maxlength="50" value="<%= notice.getNoticeTitle() %>">
						&nbsp;<br>
						<textarea rows="10" cols="65" name="noticeContent"><%= notice.getNoticeContent() %></textarea>
					</div>	
				</div>

...
<%
	...
	FaqBean faq = edit.getFaq(faqNum);
%>
<html>
<head>
<meta charset="UTF-8">
<title>인생책방::FAQ수정</title>
...
<body>
	...
	<div id="content_area">
			...
			<form name="board_form" method="post" action="faqEdit_ok.jsp">
			<input type="hidden" name="faqNum" value="<%= faqNum %>">
				<div id="info-area">
					...
					<input type="text" name="faqTitle" size="64" maxlength="200" value="<%=faq.getFaqTitle()%>">&nbsp;
					<br>
					<textarea rows="15" cols="65" name="faqContent"><%=faq.getFaqContent() %></textarea>
	       			</div>
				</div>
       			<div id="button_area">
